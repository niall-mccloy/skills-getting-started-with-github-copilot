...
activities = {
    ...
    "Soccer Team": {
        "description": "Practice teamwork and endurance while training for matches",
        "schedule": "Wednesdays, 4:00 PM - 5:30 PM",
        "max_participants": 18,
        "participants": ["liam@mergington.edu", "noah@mergington.edu"]
    },
    "Basketball Club": {
        "description": "Develop shooting, passing, and defensive skills in a competitive environment",
    ...
    "Math Olympiad": {
        "description": "Prepare for math competitions through problem-solving and advanced puzzles",
